...
class MenuItemController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($menuItemType == "G") {
            return view('dynamicmenu::menu.menuitems.index', array('menu_id' => $menuId, 'menuName' => $menu->name, 'menuItem' => $menuItem, 'menu_item_id' => $menuItemId, 'menus' => $menuItems, 'menuTrailPath' => $menuTailPath, "previousMenuItem" =>$previousMenuItem));
        } else {
            return view('dynamicmenu::menu.menuitems.edit', array('menu_id' => $menuId, 'menuName' => $menu->name, 'menuItem' => $menuItem, 'menu_item_id' => $menuItemId, 'menus' => $menuItems, 'menuTrailPath' => $menuTailPath, "previousMenuItem" =>$previousMenuItem));
        }
    }
}
